    ...
    return (
        <section className="py-16 flex flex-col container mx-auto items-center gap-10 md:px-0 px-4">
            <div className="flex items-center text-center gap-12 flex-wrap">
                <Image className="max-w-[470px] max-h-[352px] object-cover md:w-auto w-full" unoptimized src="/new-photos/2.jpeg" alt={`Expertise `} width={470} height={352} />
            ...
            <div className="flex items-center text-center gap-12 flex-wrap">
                <Image className="max-w-[470px] max-h-[352px] object-cover md:w-auto w-full" unoptimized src="/new-photos/1.jpeg" alt={`Expertise `} width={470} height={352} />
                <div className="flex flex-col gap-2">
