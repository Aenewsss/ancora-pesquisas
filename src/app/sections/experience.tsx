    ...
    return (
        <section className="py-16 flex flex-col container mx-auto items-center gap-10">
            <div className="flex items-center text-center gap-12 flex-wrap">
                <Image className="max-w-[470px] max-h-[352px] object-cover" unoptimized src="/experience/experience.jpeg" alt={`Expertise `} width={470} height={352} />
            ...
            <div className="flex flex-row-reverse items-center text-center gap-12 flex-wrap">
                <Image className="max-w-[470px] max-h-[352px] object-cover" unoptimized src="/experience/approach.jpeg" alt={`Expertise `} width={470} height={352} />
                <div className="flex flex-col gap-2">
            ...
            <div className="flex items-center text-center gap-12 flex-wrap">
                <Image className="max-w-[470px] max-h-[352px] object-cover" unoptimized src="/experience/excellence.jpeg" alt={`Expertise `} width={470} height={352} />
                <div className="flex flex-col gap-2">
